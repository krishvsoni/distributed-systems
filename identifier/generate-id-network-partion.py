...
class Node:
    ...
    def generate_id(self):
        ...
        # Implementation: Use node_id, timestamp, and a sequence number to ensure uniqueness.
        # This approach guarantees unique IDs even if the node is partitioned from the network.
        with self.lock:
